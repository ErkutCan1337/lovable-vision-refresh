...
import { CheckCircle, Shield, Lock, AlertTriangle, ArrowRight } from "lucide-react";
...
export default function Cybersecurity() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "24/7 security operations center with rapid response teams"
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src={heroImage} 
            alt="Information Security & Cybersecurity Solutions" 
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 text-lg leading-8 text-muted-foreground fade-in" style={{animationDelay: "0.1s"}}>
                Protect your digital assets with enterprise-grade security solutions designed to defend against modern cyber threats.
              </p>
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Comprehensive Protection</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Defense-in-depth security strategy
            </p>
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Our multi-layered security approach ensures complete protection across
              your entire IT infrastructure, from endpoints to cloud environments.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
              Proactively secure your organization with our comprehensive cybersecurity solutions.
            </p>
