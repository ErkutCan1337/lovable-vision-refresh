...
import { CheckCircle, Shield, FileCheck, Scale, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src={heroImage} 
            alt="Compliance and Regulatory Solutions" 
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 text-lg leading-8 text-muted-foreground fade-in" style={{animationDelay: "0.1s"}}>
                Navigate complex regulatory landscapes with confidence. Our comprehensive compliance solutions ensure your organization meets all industry standards and requirements.
              </p>
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Complete Compliance</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Stay compliant, stay confident
            </p>
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Our compliance solutions provide end-to-end support for meeting regulatory requirements,
              reducing risk, and maintaining certification standards across your organization.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
              Let our experts guide you through the compliance journey with proven solutions and continuous support.
            </p>
