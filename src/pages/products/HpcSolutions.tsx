...
import { CheckCircle, Cpu, Zap, BarChart, ArrowRight } from "lucide-react";
import { Link } from "react-router-dom";
import heroImage from "@/assets/hpc-solutions-hero.jpg";

export default function HpcSolutions() {
  const { t } = useLanguage();
  ...
  const features = [
    {
      ...
      description: "Massive parallel computing capabilities for complex calculations"
    },
    {
      icon: Zap,
      title: "GPU Acceleration",
      description: "NVIDIA and AMD GPU clusters for AI and machine learning workloads"
    },
    {
      icon: BarChart,
  ...
  const benefits = [
    ...
    "AI and ML ready infrastructure",
    "Low-latency interconnects",
    "Flexible resource allocation",
    "Expert HPC support team"
  ];
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Supercomputing Power</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Unleash the power of high-performance computing
            </p>
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Our HPC solutions deliver unprecedented computational power for research, 
              simulation, and data analysis at scale.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Accelerate your research and innovation
            </h2>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
              Join leading organizations using our HPC infrastructure to solve complex challenges.
            </p>
