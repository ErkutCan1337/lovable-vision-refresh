...
import { CheckCircle, Database, FileSearch, Cloud, ArrowRight } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Unified platform for all your organizational data needs"
    },
    {
      icon: FileSearch,
      title: "Smart Search & Retrieval",
      description: "AI-powered search capabilities for instant information access"
    },
    {
      icon: Cloud,
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src={heroImage} 
            alt="Information Management System" 
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Enterprise Solution</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Transform your data management
            </p>
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Our information management system provides a comprehensive solution for organizing, 
              storing, and accessing your critical business data efficiently.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
              Transform how your organization handles data with our comprehensive solution.
            </p>
