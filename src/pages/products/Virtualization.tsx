...
import { CheckCircle, Cloud, Layers, Settings, ArrowRight } from "lucide-react";
import { Link } from "react-router-dom";
import heroImage from "@/assets/virtualization-hero.jpg";
  ...
  const features = [
    {
      ...
      description: "Hybrid and multi-cloud virtualization platforms"
    },
    {
      icon: Layers,
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 text-lg leading-8 text-muted-foreground fade-in" style={{animationDelay: "0.1s"}}>
                {t("services.virtualization.description")}
              </p>
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Modern Virtualization</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Transform your IT infrastructure
            </p>
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Maximize efficiency and flexibility with our comprehensive virtualization 
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Optimize your IT resources today
            </h2>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
              Let us help you implement a virtualization strategy that drives efficiency and innovation.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Button size="lg" asChild>
                <Link to="/contact">
                  Get Virtualization Plan
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            </div>
