...
import { CheckCircle, Shield, Lock, Eye, ArrowRight } from "lucide-react";
import { Link } from "react-router-dom";
import heroImage from "@/assets/security-solutions-hero.jpg";
...
export default function SecuritySolutions() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Round-the-clock security operations center (SOC)"
    }
  ];
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Advanced Protection</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Comprehensive cybersecurity solutions
            </p>
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Protect your digital assets with our multi-layered security approach 
              designed to defend against modern cyber threats.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
              Secure your business with enterprise-grade security solutions today.
            </p>
