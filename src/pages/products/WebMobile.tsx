...
import { CheckCircle, Smartphone, Globe, Palette, ArrowRight } from "lucide-react";
import { Link } from "react-router-dom";
import heroImage from "@/assets/web-mobile-hero.jpg";
  ...
  const features = [
    {
      ...
      description: "Beautiful websites that work flawlessly on all devices"
    },
    {
      icon: Smartphone,
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Digital Solutions</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Build your digital presence
            </p>
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              We create stunning web and mobile applications that deliver exceptional 
