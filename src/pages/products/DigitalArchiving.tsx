...
import { CheckCircle, Archive, Lock, Shield, ArrowRight } from "lucide-react";
import { Link } from "react-router-dom";
import heroImage from "@/assets/digital-archiving-hero.jpg";

export default function DigitalArchiving() {
  const { t } = useLanguage();
  ...
  const features = [
    {
      ...
      description: "Ensure your digital assets remain accessible for decades"
    },
    {
      icon: Lock,
    ...
    },
    {
      ...
      description: "Meet regulatory requirements with automated retention policies"
    }
  ];
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Digital Preservation</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Preserve your digital legacy
            </p>
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Our digital archiving solution ensures your valuable documents and data 
              are preserved, organized, and accessible for the long term.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
              Start preserving your critical documents with our enterprise archiving solution.
            </p>
