...
import { CheckCircle, Server, Network, Cpu, ArrowRight } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Design and implementation of scalable enterprise infrastructure solutions"
    },
    {
      icon: Network,
      title: "Network Architecture",
      description: "Advanced network design with redundancy and high availability"
    },
    {
      icon: Cpu,
      title: "Hardware Integration",
      description: "Seamless integration of diverse hardware components and systems"
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src={heroImage} 
            alt="System Integration Solutions" 
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 text-lg leading-8 text-muted-foreground fade-in" style={{animationDelay: "0.1s"}}>
                {t("services.system_integration.description")}
              </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Our system integration services cover every aspect of your IT infrastructure, 
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
              Let our experts design and implement a custom system integration solution for your business.
            </p>
