...
'services.integration.subtitle': 'Altyapı kurulumu ve sistem entegrasyonu alanında profesyonel hizmetler',
    ...
    'products.info_management.description': 'Kapsamlı bilgi yönetimi ve organizasyon çözümleri',
    'products.security_management.title': 'Güvenlik Yönetim Sistemleri',
    'products.security_management.description': 'Güvenlik yönetimi ve izleme sistemleri',
    'products.digital_archiving.title': 'Dijital Arşivleme Sistemleri',
    'products.digital_archiving.description': 'Dijital arşivleme ve dokümantasyon çözümleri',
    'products.web_mobile.title': 'Web ve Mobil Teknoloji Çözümleri',
    'products.web_mobile.description': 'Web ve mobil uygulama geliştirme hizmetleri',
    'products.gis.title': 'CBS Tabanlı Bilgi Sistemleri',
    'products.gis.description': 'Coğrafi bilgi sistemleri ve haritalama çözümleri',
    'products.passenger_info.title': 'Yolcu Bilgilendirme Ekran Yazılımı',
    'products.passenger_info.description': 'Yolcu bilgilendirme ve görüntüleme sistemleri',
    'products.screen_management.title': 'Kurumsal Ekran Yönetim Yazılımı',
    'products.screen_management.description': 'Kurumsal ekran yönetimi ve içerik dağıtımı',
    'products.business_intelligence.title': 'İş Zekası',
    'products.business_intelligence.description': 'İş zekası ve veri analizi çözümleri',
    'products.process_management.title': 'Süreç Yönetim Yazılımı',
    'products.process_management.description': 'Süreç yönetimi ve optimizasyon yazılımları',
    'products.cybersecurity.title': 'Bilgi Güvenliği ve Siber Güvenlik Çözümleri',
    'products.cybersecurity.description': 'Bilgi güvenliği ve siber güvenlik çözümleri',
    'products.procurement.title': 'Satın Alma ve Varlık Yönetimi',
    'products.procurement.description': 'Satın alma ve varlık yönetimi sistemleri',
    'products.internal_control.title': 'İç Kontrol Yazılımı',
    'products.internal_control.description': 'İç kontrol ve denetim yazılım çözümleri',
    'products.strategic_planning.title': 'Stratejik Planlama Yazılımı',
    'products.strategic_planning.description': 'Stratejik planlama ve yönetim sistemleri',
    'products.license_tracking.title': 'Lisans Takip Yazılımı',
    'products.license_tracking.description': 'Lisans takip ve yönetim sistemleri',
    'products.customer_tracking.title': 'Müşteri Takip ve Randevu Sistemi',
    'products.customer_tracking.description': 'Müşteri takip ve randevu yönetim sistemleri',
    'products.hr_management.title': 'Personel Takip ve İK Yönetim Yazılımı',
    'products.hr_management.description': 'Personel takip ve insan kaynakları yönetimi',
    'products.document_management.title': 'Doküman Yönetim Sistemi',
    'products.document_management.description': 'Doküman yönetimi ve arşivleme çözümleri',
    'products.vehicle_counting.title': 'Araç Sayım ve Plaka Tanıma',
    'products.vehicle_counting.description': 'Araç sayım ve plaka tanıma sistemleri',
    'products.access_control.title': 'Erişim Kontrol Sistemleri Yönetim Yazılımı',
    'products.access_control.description': 'Erişim kontrol sistemleri yönetim yazılımı',
    'products.big_data.title': 'Büyük Veri Çözümleri',
    'products.big_data.description': 'Büyük veri analizi ve işleme çözümleri',
    
    // System Integration Services
    'integration.server_solutions.title': 'Sunucu Çözümleri',
    'integration.server_solutions.description': 'Kurumsal sunucu çözümleri ve altyapı kurulumu',
    'integration.data_storage.title': 'Veri Depolama Çözümleri',
    'integration.data_storage.description': 'Veri depolama ve yedekleme sistemleri',
    'integration.server_virtualization.title': 'Sunucu Sanallaştırma Çözümleri',
    'integration.server_virtualization.description': 'Sunucu sanallaştırma teknolojileri',
    'integration.storage_virtualization.title': 'Veri Depolama Sanallaştırma',
    'integration.storage_virtualization.description': 'Veri depolama sanallaştırma çözümleri',
    'integration.private_cloud.title': 'Özel Bulut Çözümleri',
    'integration.private_cloud.description': 'Özel bulut altyapısı ve yönetimi',
    'integration.system_automation.title': 'Sistem Otomasyonu Çözümleri',
    'integration.system_automation.description': 'Sistem otomasyonu ve süreç yönetimi',
    'integration.data_center.title': 'Veri Merkezi Çözümleri',
    'integration.data_center.description': 'Veri merkezi tasarımı ve kurulumu',
    'integration.supercomputer.title': 'Süper Bilgisayar Çözümleri (HPC)',
    'integration.supercomputer.description': 'Yüksek performanslı hesaplama sistemleri',
    'integration.it_security.title': 'BT Güvenlik Çözümleri',
    'integration.it_security.description': 'Bilişim teknolojileri güvenlik çözümleri',
    'integration.virtualization.title': 'Sanallaştırma Çözümleri',
    'integration.virtualization.description': 'Ağ ve sistem sanallaştırma teknolojileri',
    'integration.disaster_recovery.title': 'Felaket Kurtarma Çözümleri',
    'integration.disaster_recovery.description': 'Felaket kurtarma ve iş sürekliliği planları',
    'integration.big_data.title': 'Büyük Veri Çözümleri',
    'integration.big_data.description': 'Büyük veri analizi ve işleme platformları',
...
'services.integration.subtitle': 'Professional services in infrastructure setup and system integration',
    ...
    'products.info_management.description': 'Comprehensive information management and organization solutions',
    'products.security_management.title': 'Security Management Systems',
    'products.security_management.description': 'Security management and monitoring systems',
    'products.digital_archiving.title': 'Digital Archiving Systems',
    'products.digital_archiving.description': 'Digital archiving and documentation solutions',
    'products.web_mobile.title': 'Web and Mobile Technology Solutions',
    'products.web_mobile.description': 'Web and mobile application development services',
    'products.gis.title': 'GIS-Based Information Systems',
    'products.gis.description': 'Geographic information systems and mapping solutions',
    'products.passenger_info.title': 'Passenger Information Display Software',
    'products.passenger_info.description': 'Passenger information and display systems',
    'products.screen_management.title': 'Corporate Screen Management Software',
    'products.screen_management.description': 'Corporate screen management and content distribution',
    'products.business_intelligence.title': 'Business Intelligence',
    'products.business_intelligence.description': 'Business intelligence and data analysis solutions',
    'products.process_management.title': 'Process Management Software',
    'products.process_management.description': 'Process management and optimization software',
    'products.cybersecurity.title': 'Information Security and Cybersecurity Solutions',
    'products.cybersecurity.description': 'Information security and cybersecurity solutions',
    'products.procurement.title': 'Procurement and Asset Management',
    'products.procurement.description': 'Procurement and asset management systems',
    'products.internal_control.title': 'Internal Control Software',
    'products.internal_control.description': 'Internal control and audit software solutions',
    'products.strategic_planning.title': 'Strategic Planning Software',
    'products.strategic_planning.description': 'Strategic planning and management systems',
    'products.license_tracking.title': 'License Tracking Software',
    'products.license_tracking.description': 'License tracking and management systems',
    'products.customer_tracking.title': 'Customer Tracking and Appointment System',
    'products.customer_tracking.description': 'Customer tracking and appointment management systems',
    'products.hr_management.title': 'Personnel Tracking and HR Management Software',
    'products.hr_management.description': 'Personnel tracking and human resources management',
    'products.document_management.title': 'Document Management System',
    'products.document_management.description': 'Document management and archiving solutions',
    'products.vehicle_counting.title': 'Vehicle Counting and License Plate Recognition',
    'products.vehicle_counting.description': 'Vehicle counting and license plate recognition systems',
    'products.access_control.title': 'Access Control Systems Management Software',
    'products.access_control.description': 'Access control systems management software',
    'products.big_data.title': 'Big Data Solutions',
    'products.big_data.description': 'Big data analysis and processing solutions',
    
    // System Integration Services
    'integration.server_solutions.title': 'Server Solutions',
    'integration.server_solutions.description': 'Corporate server solutions and infrastructure setup',
    'integration.data_storage.title': 'Data Storage Solutions',
    'integration.data_storage.description': 'Data storage and backup systems',
    'integration.server_virtualization.title': 'Server Virtualization Solutions',
    'integration.server_virtualization.description': 'Server virtualization technologies',
    'integration.storage_virtualization.title': 'Data Storage Virtualization',
    'integration.storage_virtualization.description': 'Data storage virtualization solutions',
    'integration.private_cloud.title': 'Private Cloud Solutions',
    'integration.private_cloud.description': 'Private cloud infrastructure and management',
    'integration.system_automation.title': 'System Automation Solutions',
    'integration.system_automation.description': 'System automation and process management',
    'integration.data_center.title': 'Data Center Solutions',
    'integration.data_center.description': 'Data center design and setup',
    'integration.supercomputer.title': 'Supercomputer Solutions (HPC)',
    'integration.supercomputer.description': 'High performance computing systems',
    'integration.it_security.title': 'IT Security Solutions',
    'integration.it_security.description': 'Information technology security solutions',
    'integration.virtualization.title': 'Virtualization Solutions',
    'integration.virtualization.description': 'Network and system virtualization technologies',
    'integration.disaster_recovery.title': 'Disaster Recovery Solutions',
    'integration.disaster_recovery.description': 'Disaster recovery and business continuity plans',
    'integration.big_data.title': 'Big Data Solutions',
    'integration.big_data.description': 'Big data analysis and processing platforms',
